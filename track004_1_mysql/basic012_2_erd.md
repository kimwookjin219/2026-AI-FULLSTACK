...
ex1) 하나의 A는 하나의 B로 구성되어 있다.
A ┼───┼ B
[홍길동] ┼───┼ [주민증]

ex2) 하나의 A는 여러개의 B로 구성되어 있다.
A ┼───∈ B
한명의 학생은 여러개의 수강내역을 가진다.
[홍길동] ┼───∈ [JAVA, JSP, SPRING, MYSQL]

■3. 점선 VS 실선
실선 : 부모 테이블의 기본키를 자식테이블의 기본키로 사용
...
1) 과목과 학생은 다:다 관계
2) 부모테이블 : 개설과목, 학생 / 자식테이블 : 수강  
3) 실선,점선 무방
  실선(부모테이블 PK - 자식테이블 PK)
  점선(부모테이블 PK - 자식테이블 FK)      
