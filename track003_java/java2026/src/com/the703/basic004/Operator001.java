...
public class Operator001 {
	public static void main(String[] args) {
		...
		//Q1. 나머지연산자 - 짝수냐? 홀수냐?  (2) n%2 나머지 : 짝수 0 ,  홀수 1
		//                           0           1            0             1
		...
		//■3. 조건 &&(모든 조건을 만족시)  ||(여러 조건 중에서 하나라도 만족하면 true)
		...
		System.out.println( ++a1 ); // 2   증가시키고 출력
		System.out.println(   a1 ); // 2
		
		System.out.println( b1++ ); // 1   출력 먼저 하고 증가
		System.out.println( b1   ); // 2
		
		System.out.println( --c1 ); // 0   감소시키고 출력
		System.out.println(   c1 ); // 0
		
		System.out.println( d1-- ); // 1   출력 먼저 하고 감소
