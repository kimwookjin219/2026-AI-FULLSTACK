...
| 1차 개발 내용 | **v1 기반 기본 회원관리 기능 구현** — 회원가입, 로그인, 회원정보 관리 등 서비스의 기본 회원 기능 구현 |
| 2차 개발 | 2026.07.02 ~ 2026.07.14 |
| 2차 개발 내용 | **v2~v3 기반 기능 및 인증·보안 고도화** — Spring Boot 기반 구조 개선, 소셜 로그인 및 회원 기능 확장, Spring Security·JWT·Redis·OAuth2를 활용한 인증·인가 및 보안 기능 강화 |
| 개발 형태 | 팀 프로젝트 |
