...
|---|---|
| 프로젝트명 | MOIT (모잇) |
| 1차 개발 | 2026.06.16 ~ 2026.06.22<br>**회원관리 기본 기능 구현** — 회원가입, 로그인, 회원정보 조회·수정 등 기본 회원 기능 구현 |
| 2차 개발 | 2026.07.02 ~ 2026.07.14<br>**회원관리 및 인증·인가 고도화** — 소셜 로그인, 이메일·전화번호 인증, 회원 보안 기능 추가 및 JWT·Redis 기반 인증 구조 적용 |
| 개발 형태 | 팀 프로젝트 |
