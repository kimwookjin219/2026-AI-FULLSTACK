...
public class Network003_Book {
	public static void main(String[] args) {
		...
		try {
			...
			//Client ID        laoUqoRuDbrX1wC7M2qn
			//Client Secret    IiUMuxOBJy
			conn.setRequestMethod("GET");
			conn.setRequestProperty("X-Naver-Client-Id", "laoUqoRuDbrX1wC7M2qn");
			conn.setRequestProperty("X-Naver-Client-Secret", "IiUMuxOBJy");
...
/*
::::::::: Book 읽어오기  spring 책 찾아보기

1. 네이버 개발자 - 로그인
2. 애플리케이션 - 사용 할 API 설정
	Client ID        laoUqoRuDbrX1wC7M2qn
	Client Secret    IiUMuxOBJy
