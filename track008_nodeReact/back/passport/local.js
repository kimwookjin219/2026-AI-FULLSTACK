...
const bcrypt = require('bcrypt');  // 비밀번호 해시 비교용(암호화)
const { findUserByEmail } = require('../models/users');   // db 사용자 조회함수
module.exports = () => {
  passport.use(new LocalStrategy(
           {  usernameField: 'email',     // 로그인 시 사용할 필드명 req.body.email
              passwordField: 'password',  // 로그인 시 사용할 필드명 req.body.password
           }, //설정
