...
public class Lambda003 {
	public static void main(String[] args) {
		...
		// #2. Lambda () -> {} [RefClass]의 [method]를 사용
		...
		InterBasic basic3 = Math::max; // Math 부품, max 기능 사용 static(바로사용가능)
		System.out.println(basic3.method(10, 3));
		// Math::min
		InterBasic basic4 = (a,b) -> { return Math.min(a,b); }; // Math 부품, min 사용 static(바로사용가능)
		System.out.println(basic4.method(10, 3));
		
		InterBasic basic5 = Math::min; // Math 부품, min 기능 사용 static(바로사용가능)
		...
		// 문자열이 같으면 0, (음수) a<b a가 b 보다 앞에 온다 , (양수) a>b a가 b 보다 뒤에 온다
		...
		ex2.print("Lambda");
		// → 참조형으로 바꾸기
		Ex2 ex22 = System.out::println;
		ex22.print("Lambda");  // 결과 Lambda
	}
}
