 ...
 */
@Getter
public class CustomOAuth2User implements OAuth2User, UserDetails { //소셜 사용자 정보, 시큐리티
 
    private static final long serialVersionUID = 1L;
	
    private final Long id;             // jwt subject 유지
    ...
    @Override
    public String getPassword() { return "N/A"; }    // password 설정X
