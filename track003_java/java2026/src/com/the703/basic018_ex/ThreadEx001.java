...
public class ThreadEx001 {
	public static void main(String[] args) {
		QuestionCount cnt = new QuestionCount(); cnt.start();
		String answer = JOptionPane.showInputDialog("사과 알파벳을 입력하세요.");
				
		System.out.println(answer);
//		if(answer.equals("apple")) { System.out.println("정답입니다!"); cnt.stop(); }
//		else                       { System.out.println("정답이 아닙니다.."); cnt.stop(); }
		System.out.println( answer.toLowerCase().equals("apple") ? "정답": "오답" ); cnt.stop();
		//                         다 소문자로 변환
