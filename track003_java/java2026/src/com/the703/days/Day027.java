...
public class Day027 {
	public static void main(String[] args) { 		
		...
		List<UserInfo> users = new ArrayList<>(); //회원로그
		...
		Set<UserInfo> sets = new HashSet<>();  //회원명단
		...
		for( UserInfo u : sets) { System.out.println( ++cnt + "\t" +u.getName() + "\t" + u.getAge()); }
