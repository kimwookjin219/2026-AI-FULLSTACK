...
public class Array2Ex001 {
	public static void main(String[] args) {
		...
		//		for(int kan=0;kan<arr2[0].length;kan++){ System.out.println(arr2[0][kan]+"\t"); } System.out.println();
		//		for(int kan=0;kan<arr2[1].length;kan++){ System.out.println(arr2[1][kan]+"\t"); } System.out.println();
