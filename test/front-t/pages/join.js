...
export default function JoinPage(){
    ...
    const { me, isLoading, error, signUpDone, isEmailAvailable, checkEmailLoading,  
            isNicknameAvailable, checkNinameLoading
    ...
    <div className="container mt-4">
        ...
        <div className="mb-3 input-group">
            <input 
                type="text" className="form-control" placeholder="닉네임"  value={nickname} onChange={(e) => setNickname(e.target.value) }
            />
            <button 
                className="btn btn-outline-secondary" type="button" 
                onClick={onCheckNickname} disabled={checkNinameLoading} 
            >
