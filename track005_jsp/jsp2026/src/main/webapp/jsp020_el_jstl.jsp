...
<body>
   ...
   <div class="container card my-5">
      ...
      <p>${d}</p>
      <p>${d.a}</p> <!-- 객체명.변수명  - getter()가 있어야 사용가능 -->
      ...
      <% // 서버에서 list 형식으로 셋팅
	      String [] number2 = {"one","two","three"};
	      request.setAttribute("number2", number2);
      %>
      <c:forEach var="i" items="${number2}" varStatus="status" >
