...
class UserInfo2{
	...
	public UserInfo2(String name) { this(); this.name = name; }
...
public class SetEx001 {
	public static void main(String[] args) {
		String name =""; double avg = 0.0 ,total = 0.0; 
		...
		System.out.print("> 찾을 유저이름 : "); name = sc.next();
		
		for( UserInfo2 u : users ) {  if(u.getName().equals(name)) { System.out.println(u); break; }  }
		                                                                 // 객체의 상태정보 - toString         
