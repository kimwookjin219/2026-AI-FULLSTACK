...
public class Class003 {
	public static void main(String[] args) {
		...
		System.out.println(car1); //@73a28541 번지
			
		Car32 car3 = new Car32("red");
		System.out.println(car3 + "\t" + car3.color);
		
		Car32 car2 = new Car32(); //1. new (객체생성) 2. Car32() 초기화-null, 0  3. car1 번지
		System.out.println(car2 + "\t" + car2.color); //toString 상태 [color=null]	  null
	}
}
//////////////////////////////////////////////////////
/* [RUNTIME DATA AREA]
