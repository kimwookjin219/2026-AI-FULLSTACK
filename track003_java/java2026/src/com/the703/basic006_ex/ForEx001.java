...
public class ForEx001 {
	public static void main(String[] args) {
		...
		for(int i=1; i<=3; i++) { System.out.print( ( i==1? "":"," )+ "JAVA"+ i + "\t"); } System.out.println();
		
		//q4  for문을 이용해서 다음과 같이 출력하시오 :   HAPPY3 ,HAPPY2, HAPPY1  
		for(int i=3; i>=1; i--) { System.out.print( ( i==3? "":"," )+"HAPPY"+i+"\t"); } System.out.println();
		...
		for(int i=10; i>=1; i--) { System.out.print( ( i==10? "":"," )+i); } System.out.println();
		
		//q8  for문을 이용해서 다음과 같이 출력하시오 :   0, 2, 4, 6, 8
		for(int i=0; i<=8; i=i+2) { System.out.print( ( i==0? "":"," )+i); } System.out.println();
		
		//q9  for문을 이용해서 다음과 같이 출력하시오 :   0, 2, 4, 6, 8 ,,,중간생략 ,,, 18 
		for(int i=0; i<=18; i=i+2) { System.out.print( ( i==0? "":"," )+i); } System.out.println();
