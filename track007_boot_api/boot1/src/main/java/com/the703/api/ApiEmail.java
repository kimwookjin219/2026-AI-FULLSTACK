...
public class ApiEmail {
	...
	@Value("${naver.user}") private String user;   // heros219@naver.com
	...
	public void sendMail( String subject, String content, String to ) {
		Properties props = new Properties();
	      ...
	      try {
	         message.setFrom(  new  InternetAddress(user));  // 보내는 사람 - heros219@naver.com
	         ...
	         message.setContent("" 
	                ...
	                + "<p style='font-size:12px; color:#888; text-align:center;'>이 메일은 자동 발송된 안내 메일입니다.<br>문의: <a href='mailto:heros219@naver.com' style='color:#005bac; text-decoration:none;'>cozizii@naver.com</a></p>"
	                + "</div>"
...
//1. Naver - 이메일 (로그인) - smtp.naver.com / heros219@naver.com
//2. 2차 보안 - 비밀번호      - 7K93UEG54QHD
//3. Service
//4. Controller
//5. view