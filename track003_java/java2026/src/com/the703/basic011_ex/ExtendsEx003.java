...
class Papa extends Object{ 
	...
	public Papa() { super(); }
	public Papa(int brain) { super(); this.brain = brain; }	 // 필드있는 생성자를 쓸 경우 디폴트 생성자를 만들것!(Son에 오류가 안남)
} // end Papa
...
class Son extends Papa{ 
	...
	@Override void sing() { 
		System.out.println("빅뱅 - 붉은노을"); 
		System.out.println("IQ > " + brain);
		System.out.println("Money > " + money);
	}
	//생성자 오버로딩
	public Son() { super(); }
	//public Son(int money) { this.money = money; } 바로 위에 파라미터 int brain 자료형 같음
