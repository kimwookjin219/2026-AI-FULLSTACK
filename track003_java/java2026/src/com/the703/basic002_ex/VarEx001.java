...
public class VarEx001 {
	public static void main(String[] args) {
		int apple = 1000;
		System.out.println("사과가격은 " + apple + "원 입니다");
		System.out.print("사과가격은 " + apple + "원 입니다\n");
		System.out.printf("사과가격은 %d원 입니다\n" , apple );
		
		apple = 2000;
		System.out.println("사과가격은 " + apple + "원 입니다");
		System.out.print("사과가격은 " + apple + "원 입니다\n");
		System.out.printf("사과가격은 %d원 입니다" , apple );

	}
}
/*
연습문제1)  
패키지명 : com.the703.basic002_ex
클래스명 : VarEx001
출력내용 : 
   1-1.  apple라는 변수만들기
