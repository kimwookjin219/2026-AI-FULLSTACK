...
class Farm{
	...
	//행위(멤버함수)
	static void numPlus() { FarmNum++; /* this.age++; */ } //클래스.메서드 - method area - static  인스턴스 변수 사용불가
...
public class Class005 {
	public static void main(String[] args) {
		...
		Farm dog = new Farm();
		dog.name = "뽀이"; dog.age =7; /* dog.numPlus(); */  Farm.numPlus();
		dog.show();
	}
}
/*
...
- 객체생성과 관련이 (  X  )    객체생성은 new(인스턴스와 연관있다)
